...
import 'package:read_it/src/features/translation/presentaion/providers/translator.provider.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: _selectedText != null
          ? FloatingActionButton(
              onPressed: () async {
                if (_selectedText == null || _selectedText!.isEmpty) return;
                final translated = await ref.read(translatorProvider.notifier).translate(_selectedText!);
